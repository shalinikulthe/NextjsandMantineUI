  ...
  const rows = sortedData.map((row, index) => (
    <Table.Tr key={index}>
      {headers.map((header,indexing) => {
        ...
        //   displayValue = `${cellValue?.street}, ${cellValue?.city}, ${cellValue?.zipcode}`;
        // } else if (header.key === 'geo') {
        //   displayValue = `${cellValue?.lat}, ${cellValue?.lng}`;
        // }

        console.log(displayValue,"displayValuedisplayValuedisplayValuedisplayValuedisplayValuedisplayValuedisplayValue")
